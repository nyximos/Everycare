                ...
                <div class="resumeType1">
                    <div class="resumeType1-inner">
                        <div id="ResumeBaseInfo" class="resumeView">
                            ...
                            <div class="photoArea">
                                <span class="photo">
                                    <a
                                        href="#ResumeBaseInfo"
                                        class="image"
                                        style="position: static; left: 0; bottom: 0; display: block; width: auto; height: auto; padding: 0; border: 0 none; background: none"
                                    >
                            ...
                            <ul class="infoList">
                                <li class="name">
                                    <strong>{{ name }}</strong> <em>{{ birth }}</em> · ( {{ gender }} ) <br />
                                </li>
                                <li class="address">
                                    <span class="info-title">주소</span><span class="star">{{ address }}</span>
                                </li>
                                <li class="contact">
                                ...
                                <li class="mail">
                                    <span class="info-title">이메일</span><span class="star">{{ email }}</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div id="ResumePR" class="resumeView">
                            <h2>자기소개서</h2>
                            <div class="ResumeOpenBox">
                                <span class="lockIcon">{{ introduction }}</span>
                                <p class="first"></p>
                            </div>
                        </div>
...
/* 이력서보기(type1) - 자격증 */
#ResumeLicense .subTitle li {
    width: 346px;
}
#ResumeLicense .subTitle li.first {
    width: 335px;
}
#ResumeLicense .infoArea {
    overflow: visible;
    margin: 0;
}
#ResumeLicense .infoArea .nameArea {
    overflow: visible;
    float: none;
    width: 738px;
    margin: 0;
}
#ResumeLicense .infoArea .nameArea::after {
    content: '';
    display: block;
    clear: both;
}
#ResumeLicense .infoArea .nameArea p.name {
    float: left;
    width: 369px;
    font-size: 16px;
    font-weight: bold;
...
#ResumeLicense .infoArea .nameArea p.date {
    overflow: hidden;
    width: 369px;
    margin: 0;
    font-size: 15px;
