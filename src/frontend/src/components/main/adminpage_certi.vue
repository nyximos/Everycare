                    ...
                    <div class="navbar-header" data-logobg="skin5">
                        <a class="navbar-brand" href="index.html">
                            <b class="logo-icon ps-2">
                                <img src="@/assets/main.png" alt="homepage" class="light-logo" width="25" />
                            </b>
                        ...
                        <ul class="navbar-nav float-end">
                            <li class="nav-item dropdown">
                                <a
                                    ...
                                    aria-expanded="false"
                                >
                                    <img src="@/assets/profileuser.png" alt="user" class="rounded-circle" width="31" />
                                </a>
                ...
                <div class="scroll-sidebar">
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav" class="pt-4 in">
                            ...
                            <li class="sidebar-item">
                                <router-link to="/admin_report" class="sidebar-link waves-effect waves-dark sidebar-link" href="#" aria-expanded="false"
                                    ><i class="mdi mdi-alert-box"></i>&nbsp;&nbsp;<span class="hide-menu">신고 관리</span></router-link
                                >
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" aria-expanded="false"
                                    ><i class="mdi mdi-store"></i>&nbsp;&nbsp;<span class="hide-menu">스토어 관리</span></a
                                >
                            </li>
                            <li class="sidebar-item selected">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link active" href="#" aria-expanded="false"
                                    ><i class="mdi mdi-file-outline"></i>&nbsp;&nbsp;<span class="hide-menu">케어시터 자격증 승인</span></a
                                >
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" aria-expanded="false"
                                    ><i class="mdi mdi-filter-outline"></i>&nbsp;&nbsp;<span class="hide-menu">케어 활동 분류 관리</span></a
                                >
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link has-arrow waves-effect waves-dark" href="#" aria-expanded="false"
                                    ><i class="mdi mdi-information"></i>&nbsp;&nbsp;<span class="hide-menu">건강 정보 관리</span></a
                                >
                            </li>
                        </ul>
                    </nav>
...
@media (min-width: 768px) {
    #main-wrapper[data-layout='vertical'][data-sidebartype='mini-sider'] .topbar .top-navbar .navbar-brand {
        width: 65px;
    }
}
