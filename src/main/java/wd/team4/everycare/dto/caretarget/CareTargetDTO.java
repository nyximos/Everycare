...
public class CareTargetDTO {
    ...
    public CareTargetDTO(String name, Gender gender, LocalDate birth, Long height, Long weight, String zipcode, String address, String detaildAddress, int longTermCareGrade, String comment, int pet, int isCctvAgrement, CareType careType, int coronaTest, Member member) {
        this.name = name;
        this.gender = gender;
        this.birth = birth;
        this.height = height;
