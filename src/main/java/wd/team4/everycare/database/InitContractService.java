...
public class InitContractService {
    ...
    public void dbInit() {
        ...
        Contract contract3 = oldContract("contract3", LocalDate.now(), LocalDate.now(), "10:00", "11:00", 1000, 0, 10000, LocalDateTime.now(), "BC", "123456789", "payApprove1", 1, jobOffer1, member1, careSitter1);
        Contract contract4 = oldContract("contract4", LocalDate.now(), LocalDate.now(), "10:00", "11:00", 1000, 1, 10000, LocalDateTime.now(), "AB", "987654321", "payApprove2", 2, jobOffer2, member2, careSitter2);
    }
