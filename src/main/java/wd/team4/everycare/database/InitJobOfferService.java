...
public class InitJobOfferService {
        ...
        public void dbInit() {
                ...
                JobOffer jobOffer1 = jobOffer("케어시터분 구합니다.", LocalDate.parse("2022-05-01"),
                                LocalDate.parse("2022-05-31"), "2022-06-13,2022-06-14", "09:00", "18:00", 10000, 130000,
        ...
        private CareTargetSchedule careTargetSchedule(String name, String startTime, String endTime,
