...
public class InitProductCategoryService {
    ...
    public void dbInit(){
        ...
        createChildProductCategory("휠체어", productCategory2);
        createChildProductCategory("전동휠체어/스쿠터", productCategory2);
        ...
        createChildProductCategory("욕창예방매트/방석", productCategory3);
        createChildProductCategory("간병침대/간병용품", productCategory3);
        createChildProductCategory("환자영양식", productCategory3);
        ...
        createChildProductCategory("침구/반신욕/찜질기", productCategory5);
        createChildProductCategory("안마/재활/물리치료", productCategory5);
        createChildProductCategory("호흡/신종플루용품", productCategory5);
        ...
        createChildProductCategory("생활가전/가구", productCategory6);
